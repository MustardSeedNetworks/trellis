...
| --- | --- | --- | --- |
| R1 | **GPU portability** (Vulkan/Metal/D3D12 divergence) | High | Commit to **wgpu-native/Dawn** early; write kernels once; CPU/SIMD fallback so nothing _requires_ a GPU. |
