...
// GetScanner returns the configured Scanner for testing.
func (m *Manager) GetScanner() any {
	return m.scanner
}

// GetConnMonitor returns the configured ConnectionMonitor for testing.
func (m *Manager) GetConnMonitor() any {
	return m.connMonitor
}

// GetThroughputMeter returns the configured ThroughputMeter for testing.
func (m *Manager) GetThroughputMeter() any {
	return m.throughputMeter
}
